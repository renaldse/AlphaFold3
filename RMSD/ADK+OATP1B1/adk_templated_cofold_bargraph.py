...
# Path to CIF files
BASE = "/mnt/gs21/scratch/renaldse/AlphaFold3/outputs/ADK_ATP_templated_cofold_May20_2026_4.35PM/adk"
SEED = "seed-1346664333"
SAMPLES = [0, 1, 2, 3, 4]
...
ax.set_title('ADK - Ca RMSD vs sample-0 (Templated Cofolded)')
ax.legend()
plt.tight_layout()
plt.savefig('/mnt/gs21/scratch/renaldse/AlphaFold3/RMSD/adk_templated_cofold_rmsd.png', dpi=150)
plt.close()
print("Saved adk_templated_cofold_rmsd.png!")
