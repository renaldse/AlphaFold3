...
ax.set_title('OATP1B1 - Ca RMSD vs sample-0 (Templated Cofolded)')
ax.legend()
plt.tight_layout()
plt.savefig('/mnt/gs21/scratch/renaldse/AlphaFold3/RMSD/oatp1b1_templated_cofold_rmsd.png', dpi=150)
plt.close()
print("Saved oatp1b1_templated_cofold_rmsd.png!")
