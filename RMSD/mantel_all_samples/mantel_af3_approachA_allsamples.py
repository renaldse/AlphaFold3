...
Run:
    python mantel_af3_approachA.py --seq seq15
    python mantel_af3_approachA.py --seq seq13 --mode ca
    python mantel_af3_approachA.py --seq seq5  --mode allatom
"""
...
def plot_matrices(tmpl_mat, samp_mat, seq, mode, r, p, out_path: Path):
    ...
    for ax_idx, (mat, title) in enumerate([
        (tmpl_mat, "Template pairwise RMSD (A)"),
        (samp_mat, "Sample mean pairwise RMSD (A)")
    ]):
